 ...
 * generated in the com.marlabs.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://soap.marlabs.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://soap.marlabs.com/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.marlabs.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.marlabs.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.marlabs.com/", name = "helloWorldResponse")
