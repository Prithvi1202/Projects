 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://soap.marlabs.com/", wsdlLocation = "http://172.17.30.35:2345/WS/HelloWorld?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://soap.marlabs.com/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.17.30.35:2345/WS/HelloWorld?WSDL");
    ...
    public IHello getHelloImplPort() {
        return super.getPort(new QName("http://soap.marlabs.com/", "HelloImplPort"), IHello.class);
    }
    ...
    public IHello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.marlabs.com/", "HelloImplPort"), IHello.class, features);
    }
