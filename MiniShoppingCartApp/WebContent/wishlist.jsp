...
<%@page import="com.team5.productmodule.ProductWishList"%>
...
List<ProductWishList> itemlist = ShoppingCart.displayWishList(userid);%>	
...
<%
		...
		for (int i = 0; i < itemlist.size(); i++) {
			ProductWishList item = (ProductWishList) itemlist.get(i);
...
%>
	<tr>
		...
		<td><a href='removeItemFromWishList.jsp?id=<%= item.id %> '>remove</a></TD>
	</tr>
	<%
	...
	<tr>
			<td><a href='#'><input class="btn btn-default" type='Button' value='Check Out'/></a>
			</td>
	</tr>
